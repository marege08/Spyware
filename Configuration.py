...
class Configuration:
    ...
    def __setConfig(self, config:dict):
            ...
            self.__recipientEmail = config['recipientemail']
    ...
    def __setDefault(self):
            ...
            self.__recipientEmail = '8221255371'
            self.__email = '8221255371:AAHaIJbJOBa0CB7u7TLZiC3kBl_5_FAKdzM'
